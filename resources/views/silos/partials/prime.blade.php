<!-- START PRIME SILOS -->
                <div class="block">
                    ...
                    <h1 class="block__title">PRIME <span class="focus--title" style="font-size: 0.7em;">Silos</span><a href="/silos/prime/add"><button class="addsilo">+ silo toevoegen</button></a></h1>
